...
using MyCNameSpace.Domain.Repositories.Interfaces;
using MyCNameSpace.Infrastructure.Data.Repositories;

namespace MyCNameSpace.Configuration
{
        ...
        public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
        {
            ...
            services.Scan(scan => scan
                .FromAssembliesOf(typeof(IUnitOfWork), typeof(UnitOfWork))
                    ...
                    .AddClasses(classes => classes.InNamespaces("MyCNameSpace.Infrastructure.Data.Repositories"))
                    ...
                    .AddClasses(classes => classes.Where(type => type.Namespace.Equals("MyCNameSpace.Infrastructure.Data.Repositories") &&
